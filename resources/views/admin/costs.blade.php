                    ...
                    <div class="" style="width: 100%;">
                      <div class="card">
                        ...
                        <div class="searchfilters" id="searchfilters">
                          ...
                          <input type="number" id="year1" name="fromyear" class="filterbox" min="1900" max="2040"
                            step="1" value="{{$fromyear == 0 ? 2022 : $fromyear}}" />

                          <select class="filterbox" id="month1" name="frommonth" onchange="show_month()">
                        ...
                        @endphp
                        <span class="text-center mt-4">Cost Expenditure Pie Chart</span>
                            ...
                            <table class="table table-striped table-valign-middle" id="tablemainundefined">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href="{{asset('uploads/'.$expense->receipt)}}" target="_blank">
                                      <img style="height: 35px; width: 35px; border-radius: 50%;"
                                        src="{{asset('uploads/'.$expense->receipt)}}" alt="" />
                                    </a>
                                  </td>
                                  <td>
                                    <i class="fas fa-trash" onclick="showDelete('{{$expense->id}}')"></i>
                                  </td>
                                <tr>
                                  @endforeach
      ...
      <form action="{{route('addExpense')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="dialog">
          <div class="flex">
            ...
            <input style="margin-left: 33px;" type="number" name="year" id="year3" class="filterbox" min="1900"
              max="2040" step="1" value="2022" />
            <select style="width: 100%; margin-right: 0; max-width: 100%;" name="month" class="filterbox" id="month3">
              <option selected value="">--Select Month--</option>
